...
- OGNI riga di un file diviso è una SPESA. I soldi che mi tornano indietro non sono un'entrata: sono il motivo per cui la mia quota è PIÙ PICCOLA del costo della riga, e sono già contati nel momento in cui prendo la mia quota invece di quello che ho anticipato. Una riga di vacanza che arriva come entrata sotto una categoria di stipendio è il segno più chiaro che la regola dei saldi è stata saltata: su un saldo di +144,82 con un costo di 181,03 la mia quota è 36,21, non 144,82 e non un'entrata.
