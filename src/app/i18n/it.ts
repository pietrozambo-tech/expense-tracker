...
export const it: Record<keyof typeof en, string> = {
  ...
  'conf.eraseMsgGuest': 'Elimina definitivamente tutte le tue transazioni, categorie, fonti e impostazioni, e fa ripartire l’app da zero.',
  'conf.eraseMsgUser': 'Elimina tutte le tue transazioni, categorie, fonti e impostazioni e fa ripartire l’app da zero. Il tuo account resta: puoi riaccedere quando vuoi. Per rimuovere anche l’account, usa Elimina account.',
  'conf.eraseCta': 'Cancella',
  'conf.restoreTitle': 'Ripristinare questo backup?',
  'conf.restoreMsg': 'Sostituisce tutte le transazioni, categorie, fonti e impostazioni attuali con il contenuto del file di backup.',
  'conf.restoreCta': 'Ripristina',
  'conf.delAccTitle': 'Eliminare il tuo account?',
  'conf.delAccMsg': 'Elimina definitivamente il tuo account TracklyLab e tutti i tuoi dati - transazioni, categorie, fonti e impostazioni - dai nostri server e da questo dispositivo. Non si può annullare.',
  ...
  'mgmt.yourSources': 'Le tue fonti',
  'mgmt.addSource': 'Aggiungi fonte',
