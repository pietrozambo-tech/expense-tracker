...
export const it: Record<keyof typeof en, string> = {
  ...
  'set.insightsRow': 'Mostra sulla Dashboard',
  ...
  'set.profileSub': 'Il tuo nome, il tuo budget mensile e come inizia la settimana',
  'set.name': 'NOME',
  'set.monthlyBudget': 'BUDGET MENSILE',
  'set.noLimit': 'Nessun limite',
  'set.budgetHint': 'Mostra una barra di avanzamento sulla Dashboard per il mese corrente. Lascia vuoto per nessun limite.',
