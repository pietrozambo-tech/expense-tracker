...
export const it: Record<keyof typeof en, string> = {
  ...
  'set.profileHint': 'Il budget mostra una barra sulla Dashboard del mese corrente; lascialo vuoto per nessun limite. Nome e budget si salvano con il pulsante qui sotto.',
