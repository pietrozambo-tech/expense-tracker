...
export const en = {
  ...
  'ftrip.all': 'All trips',
  'act.menu.export': 'Export',
  'act.menu.select': 'Select',
  ...
  'sel.account': 'Account',
  'sel.catTitle.one': 'Move 1 transaction',
  'sel.catTitle.other': 'Move {n} transactions',
  'sel.apply': 'Apply',
  'sel.mixed': 'Expenses and income use different categories - select one kind at a time.',
  'sel.moved.one': '1 transaction moved to {name}',
  'sel.moved.other': '{n} transactions moved to {name}',
  'sel.onSource.one': '1 transaction moved to {name}',
  'sel.onSource.other': '{n} transactions moved to {name}',
  'sel.srcTitle': 'Choose the account',
  'sel.delTitle.one': 'Delete this transaction?',
  'sel.delTitle.other': 'Delete {n} transactions?',
  'sel.delBody': '{total} in all. You will have a moment to undo.',
  'sel.delBodyShared': '{total} in all. {n} of them are shared, so this cannot be undone.',
  'sel.recTitle': 'Some of these repeat',
  'sel.recBody': '{n} of the selected transactions are created by a schedule. Delete just these, or stop the schedules as well?',
  'sel.recOnly': 'Just these',
  'sel.recStop': 'Stop the schedules',
  'sel.recStopExtra': 'Stopping them also removes {n} later transactions you did not select.',
  'sel.deleted.one': '1 transaction deleted',
  'sel.deleted.other': '{n} transactions deleted',
  'sel.undo': 'Undo',
  ...
  'trips.emptyBody': 'A trip groups travel expenses under one name, so a holiday adds up on its own \u2014 flights booked months earlier included. Pick a few expenses and it exists.',
  'trips.emptyCta': 'Pick expenses',
  'trips.editAria': 'Edit the {name} trip',
  'trips.editTitle': 'Edit trip',
  'trips.newTitle': 'New trip',
  'trips.pick': 'PICK ITS EXPENSES',
  'trips.recent': 'Just recent',
  'trips.inTrip': 'IN THE TRIP',
  'trips.showAll': 'Show {n} more',
  'trips.nearby': 'NEARBY, IN NO TRIP',
  'trips.wider': 'Look further',
  'trips.narrower': 'Just the trip',
  'trips.noNearby': 'Nothing here that is not already in a trip.',
  'trips.takenOut': 'Taken out',
  'trips.floor': 'Under {n} expenses this stops being a trip. The expenses stay, and putting one back brings it straight back.',
  'trips.renameTitle': 'Rename the trip',
  'trips.renameBody': 'Changes the name on every one of its expenses.',
  'trips.renameInvalid': 'The app would not recognise the trip any more. At most 3 words and 24 characters, and no " - " inside.',
  'trips.renameMerge': 'It will merge into {name} · {month}.',
  'trips.inAll': 'in all',
  ...
  'add.order.aria': 'Sorting of the category list',
  'add.order.alpha': 'A-Z',
  ...
  'imp.already.one': '{n} row was already imported earlier and was skipped - nothing double-counted.',
  'imp.already.other': '{n} rows were already imported earlier and were skipped - nothing double-counted.',
  ...
  'toast.importedDedupe': '{n} already imported earlier were skipped - nothing double-counted',
  'toast.nothingNew': 'Nothing new to import',
  'toast.nothingNewDesc': 'All {n} transactions were already imported earlier - nothing double-counted.',
  ...
  'nudge.recapSaved': 'saved {amount}',
  'nudge.recapCta': 'See the full story',
  'nudge.installTitle': 'Add TracklyLab to your Home Screen',
  'nudge.installBody': 'Installed, it opens like an app, works offline, and your data is kept safe by the system.',
  'nudge.installHow': 'Show me how',
  'nudge.installIos1': 'Tap Share in Safari (the square with the arrow)',
  'nudge.installIos2': "Choose 'Add to Home Screen'",
  'nudge.installIos3': 'Open TracklyLab from its new icon',
  'nudge.installAnd1': 'Tap the menu in Chrome (three dots)',
  'nudge.installAnd2': "Choose 'Add to Home screen' or 'Install app'",
  ...
  'set.recapToggleSub': 'Last month in one line, when a new month starts',
  'set.notifPush': 'Push notifications will arrive with the App Store version.',
  'set.title': 'Settings',
  ...
  // ── the in-app AI import (the door is in Settings, the flow in AiImport) ──
  'ai.doorTitle': 'Add from your own data',
  'ai.doorSub': 'Bank statements, Excel sheets, trip exports, screenshots: pick the file and half a minute later the expenses are in the app, already sorted.',
  'ai.pickHint': 'Several files or pages at once is fine.',
  'ai.card1Title': 'Banks & cards',
  'ai.card1Body': 'PDF or CSV statements, Excel sheets - even a screenshot of a list.',
  'ai.card2Title': 'Trips & split expenses',
  'ai.card2a': 'A Splitwise or',
  'ai.card2b': 'export lands as your share only - settlements between people are skipped.',
  'ai.smartTitle': 'Fitted to your app',
  'ai.smartBody': 'Expenses arrive already matched to your categories, subcategories and accounts - the way you built them.',
  'ai.kind1': 'PDF statements',
  'ai.kind2': 'Excel & CSV',
  'ai.kind3': 'Screenshots',
  ...
  'ai.readingSub': 'About twenty seconds. You can watch.',
  'ai.countOf': '{n} of {total}',
  'ai.tick1': 'Dates and amounts',
  'ai.tick2': 'Categories - yours',
  'ai.tick3': 'Checking for duplicates',
  'ai.nothingYet': 'No expense has been added yet',
  'ai.questionsTitle': 'One thing first',
  'ai.questionsSub': 'Answer with a tap and I carry on.',
  'ai.freeAnswer': 'Or type…',
  'ai.readyTitle': 'Ready',
  'ai.readySub': 'I took out the ones you already had.',
  'ai.toAdd': 'To add',
  'ai.newCount': '{n} new expenses',
  'ai.already': '{n} were already here',
  'ai.already1': '1 was already here',
  'ai.skippedN': '{n} rows skipped',
  'ai.skipped1': '1 row skipped',
  'ai.moreRows': 'and {n} more…',
  'ai.commit': 'Add the {n} expenses',
  'ai.closeNothing': 'Nothing new - close',
  'ai.lastToday': "That was today's last read.",
  'ai.close': 'Close',
  'ai.retry': 'Try again',
  'ai.errTitle': "I couldn't read it",
  'ai.errSub': 'Nothing has been touched. Try again?',
  "ai.errLimitTitle": "That's it for today",
  'ai.errLimitSub': 'We can pick this up again tomorrow.',
  ...
  'bal.title': 'Balance history',
  'bal.subtitle': 'Every move that got it here, newest first',
  'bal.empty': 'Nothing has moved the balance yet',
  'bal.settledMark': 'settled',
  'bal.theyPaidYou': '{name} paid you',
  'bal.youPaidThem': 'You paid {name}',
  'bal.youPaid': 'You paid {amt} · {share} yours',
  'bal.theyPaid': '{name} paid {amt} · {share} yours',
  'shared.set.history': 'Balance history',
  'shared.set.historyHint': 'Every expense and settlement, month by month.',
  'shared.cat.title': '{name}’s categories',
  'shared.cat.row': '{name}’s categories',
  'shared.cat.need.one': '1 needs you',
  'shared.cat.need.other': '{n} need you',
  'shared.cat.hint': 'Categories {name} invented that have nowhere of yours to go. Until you pick one, their expenses sit in your catch-all.',
  'shared.cat.intro': 'Pick where each of these should land. Past expenses move too.',
  'shared.cat.count.one': '{n} expense',
  'shared.cat.count.other': '{n} expenses',
  'shared.cat.filed': 'Filed under {name}',
  'shared.cat.empty': 'Nothing of {name}’s needs a home right now.',
  'shared.cat.choose': 'Choose a category',
  'shared.settleTitle': 'Settle up',
  'shared.settleBody.them': '{name} pays you {amt} and the balance returns to zero. Your spending, income and budget don’t move.',
  'shared.settleBody.you': 'You pay {name} {amt} and the balance returns to zero. Your spending, income and budget don’t move.',
  ...
  'shared.news.title': 'New since you last looked',
  'shared.news.added.one': '{name} added a shared expense',
  'shared.news.added.other': '{name} added {n} shared expenses',
  'shared.news.changed.one': '{name} made a change',
  'shared.news.changed.other': '{name} made {n} changes',
  'shared.news.inYour': '{amt} in your {period}',
  'shared.news.owesYouNow': '{name} owes you {amt} now',
  'shared.news.youOweNow': 'You owe {name} {amt} now',
  'shared.news.evenNow': 'You are even now',
  'shared.news.wasBal': 'was {amt}',
  'shared.news.was': 'was {amt}',
  'shared.news.more': '+{n} more',
  'shared.news.tag.new': 'New',
  'shared.news.tag.updated': 'Updated',
  'shared.news.tag.removed': 'Removed',
  'shared.was.title': '{name} changed this while you were away',
  'shared.was.amounts': '{from} → {to}',
  'shared.was.share': 'your share {from} → {to}',
  'travel.use': 'Travelling? Use {code}',
  'travel.useAria': 'Use {code} for this entry',
  'travel.dismissAria': 'Not travelling',
