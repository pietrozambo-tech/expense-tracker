...
export const en = {
  ...
  'review.hideAria': 'Hide the review card',
  'review.hideTitle': 'Hide monthly insights?',
  'review.hideBody': 'The review card will stop appearing on finished months. You can switch it back on any time in Settings › Profile.',
  'review.hideConfirm': 'Hide it',
  'set.insights': 'Monthly insights',
  'set.insightsHint': 'A short review of each finished month: how it compared with your usual, and what drove it.',
  'review.topCategory': 'Top category',
  'review.biggest': 'Biggest expense',
  'review.without': 'Without {name}',
  'review.pointer': '{period} in review',
