...
export const en = {
  ...
  'set.shared': 'Shared',
  'set.shared.off': 'Off',
  'shared.set.introTitle': 'Split costs with one person',
  'shared.set.introBody': 'Enter the full amount you paid — only your share counts in your budget, and the app keeps the balance between you.',
