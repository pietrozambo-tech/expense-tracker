...
export const en = {
  ...
  'ai.doorSub': "Pick a file - I'll do the rest.",
  'ai.pickHint': 'Several files or pages at once is fine.',
  'ai.card1Title': 'Banks & cards',
  'ai.card1Body': 'PDF or CSV statements, Excel sheets, screenshots.',
  'ai.tricountTitle': 'Tricount has no export button',
  'ai.tricountBody': 'Splitwise hands you a CSV of its own. Tricount does not - so this free tool makes one: paste your Tricount share link into it and it gives you back a CSV. That file is the one you bring here.',
  'ai.tricountNote': 'It is a separate tool, not part of TracklyLab.',
  'ai.tricountGo': 'Open the tool',
  'ai.card2Title': 'Trips & split expenses',
  'ai.card2a': 'Splitwise or',
  'ai.card2b': ': only your share comes in.',
