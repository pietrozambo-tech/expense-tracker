...
export const en = {
  ...
  // Scheduled (upcoming recurring transactions)
  ...
  'sched.stopTitle': 'Stop this schedule?',
  'sched.stopBody': 'No further occurrences of {name} will be created. Everything already recorded stays.',
  'sched.stopConfirm': 'Stop schedule',
  'sched.editAria': 'Edit the {name} schedule',
  'sched.stopAria': 'Stop the {name} schedule',
  'sched.emptyTitle': 'Nothing scheduled yet',
  'sched.emptyBody': 'Add a schedule for anything that repeats - rent, a salary, a subscription - and it will appear here before it happens.',
  'sched.toastCreated': 'Schedule created',
  'sched.toastUpdated': 'Schedule updated',
  'sched.toastStopped': 'Schedule stopped',
