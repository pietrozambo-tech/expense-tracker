...
export const en = {
  ...
  'set.insightsRow': 'Show on Dashboard',
  ...
  'set.profileSub': 'Your name, your monthly spending limit and how your week starts',
  'set.name': 'NAME',
  'set.monthlyBudget': 'MONTHLY BUDGET',
  'set.noLimit': 'No limit',
  'set.budgetHint': 'Shows a progress bar on your Dashboard for the current month. Leave empty for no limit.',
