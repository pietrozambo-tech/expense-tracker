// Vendored from the data-viz skill's validator, unchanged below this header.
//
// Here so the series palette in src/styles/index.css cannot drift by hand:
// test-colors.mjs feeds it the tokens from BOTH themes and fails the build if
// any check stops passing. The maths - OKLab, the three colour-blindness
// simulations, WCAG contrast - is the point; re-deriving it by eye is exactly
// what this replaces.
//
/**
