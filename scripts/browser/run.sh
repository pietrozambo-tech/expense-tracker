...
declare -A EXP=( [authboot]=14 [offline]=9 [offlineui]=12 [smoke]=8 [importreview]=12 [allyears]=13 [toast]=4 [catorder]=11 [subsort]=6 [drilldim]=5 [bulkselect]=26 [trips]=99 [edit]=31 [setuptip]=33 [prompt]=5 [backdate]=13 [triprow]=46 [tripfilter]=18 [demotrip]=12 [touchhover]=7 [aiimport]=33 )
total=0; bad=0
for name in "${!EXP[@]}"; do
